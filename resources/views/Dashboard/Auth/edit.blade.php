                                    ...
                                    <div class="form-group mb-3 m-auto">
                                        ...
                                        <div class="row">
                                            <div class="col-6 m-auto mb-2">
                                                ...
                                                No Avatar
                                                @else
                                                <img  style="object-fit:cover ;width: 200px ; height: 200px;" src="{{Storage::disk('s3')->url(Auth()->user()->avatar)}}" alt="{{Auth()->user()->name}}" class="mb-3 col-12 rounded-circle m-auto">
                                                @endif
                                            </div>
                                        </div>
