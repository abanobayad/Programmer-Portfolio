                            ...
                            <div class="card-body" style="overflow-y: auto;">
                                <a class="dropdown-item  " href="{{ route('markRead', $notification->id) }}">
                                    <h5 class="card-title" style="text-overflow: clip;">
                                        <div class="row mb-1">
                                            <div class="col-8">
                                                <span class="preview-subject ellipsis font-weight-medium text-light" >
                                                    {{ $notification->data['data']['title'] }}</span>
                                            </div>
                                            <div class="col-4 ">
                                                {{-- Icon Cond --}}
                                                @if ($notification->type == 'App\Notifications\NewContact')
                                                    <i class="mdi mdi-contacts px-5 mx-3  text-success"></i>
                                                @elseif ($notification->type == 'App\Notifications\NewHire')
                                                    <i class="mdi mdi-worker px-5 mx-3 text-danger"></i>
                                                @endif
                                                {{-- End Icon Cond --}}
                                            </div>
                                        </div>
